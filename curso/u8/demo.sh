...
neutron subnet-update subred2 --host_routes type=dict list=true destination=75.10.3.0/24,nexthop=75.10.2.254 
...
neutron router-update r2 --routes type=dict list=true destination=75.10.3.0/24,nexthop=75.10.2.254
# Añadimos una ruta de encaminamiento en r3 para que poueda acceder a la red1
neutron router-update r3 --routes type=dict list=true destination=75.10.1.0/24,nexthop=75.10.2.1
